module ActionView::Attributes::TagBuilder
  ...
  included do
    ...
    #
    # To treat addition attributes as token lists, add values to the <tt>ActionView::Attributes.token_lists</tt> value:
    #
    #   ActionView::Attributes.token_lists << "data-action"
    #   ActionView::Attributes.token_lists << "data-controller"
    #   ActionView::Attributes.token_lists << /data-(.*)-target/
    #
